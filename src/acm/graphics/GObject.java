...
public abstract class GObject implements Cloneable, Serializable, GScalable {
	 ...
	 *
	 * @param dx The distance to go the object in the x direction (positive is rightward)
	 * @param dy The distance to go the object in the y direction (positive is downward)
	 * @usage gobj.go(dx, dy);
	 */
	 ...
	 * parameter <code>r</code> specifies the distance to go and <code>theta</code>
	 ...
	 *
	 * @param r     The distance to go
	 * @param theta The angle in which to go, measured in degrees
