...
abstract class AbstractKarel implements KarelInterface, ProgramInterface, Runnable {
	...
	public void get() {
		...
		if (nb < 1) {
			throw new ErrorException("get: No beepers on this corner (" + x + ", " + y + ")");
		}
		world.setBeepersOnCorner(x, y, KarelWorld.adjustBeepers(nb, -1));
		setCrystalsInBag(KarelWorld.adjustBeepers(getCrystalsInBag(), +1));
		world.trace();
	}
